...
<?php if ($this->ion_auth->in_group(array('Accountant', 'Receptionist', '', 'Laboratorist', 'Pharmacist', ''))) { ?>
    <li class="nav-item">
        <a class="nav-link text-white" href="#">
...
<?php if ($this->ion_auth->in_group(array('Doctor', 'Nurse'))) { ?>
    <li class=" nav-item">
        <a class="nav-link text-white" href="https://panel.drnext.ir/">
            <i class="text-secondary nav-icon fas fa-globe"></i>
            <p>دکترنکست </p>
        </a>
    </li>
...
<?php if ($this->ion_auth->in_group(array('Doctor', 'Nurse'))) { ?>
    <li class=" nav-item">
        <a class="nav-link text-white" href="https://esakhad.esata.ir:9092/authentication/login">
            <i class="text-secondary nav-icon fas fa-globe"></i>
            <p>ساخد</p>
        </a>
    </li>
