                                                            ...
                                                            <div class="col-lg-4">
                                                                <div class="info-group mb-4">
                                                                    ...
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <div class="font-weight-medium"><?php echo $patient->birthdate; ?></div>
                                                                    </div>
                        ...
                        <div class="col-md-6 mb-4">
                            <div class="form-group">
                                <label
                                    ...
                                    <span class="text-danger">*</span></label>
                                <input type="text" class="form-control form-control-lg shadow-sm" name="email"
                                    required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12 mb-4">
                            <div class="form-group">
                                <label
                                    ...
                                    <span class="text-danger"></span></label>
                                <textarea class="form-control shadow-sm" rows="3" name="address" ></textarea>
                            </div>
                        </div>
                        <div class="col-md-6 mb-4">
                            <div class="form-group">
