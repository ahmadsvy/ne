                                ...
                                <div class="row mb-5">
                                    ...
                                    <div class="col-md-6 mb-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control form-control-lg shadow-sm" name="email" placeholder="کدملی" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4 mb-4">
                                        <div class="form-group">
                                            ...
                                            <input type="tel" class="form-control form-control-lg shadow-sm" name="phone" placeholder="شماره تماس" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4 mb-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control form-control-lg shadow-sm" name="birthdate">
                                        </div>
                                    </div>
